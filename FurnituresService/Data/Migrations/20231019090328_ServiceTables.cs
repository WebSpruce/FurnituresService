...
{
    /// <inheritdoc />
    public partial class ServiceTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartFurnitures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartFurnitures_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartFurnitures_Furnitures_FurnitureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderFurnitures_Furnitures_FurnitureId",
                        column: x => x.FurnitureId,
                        principalTable: "Furnitures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartFurnitures_CartId",
                table: "CartFurnitures",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_CartFurnitures_FurnitureId",
                table: "CartFurnitures",
                column: "FurnitureId");
